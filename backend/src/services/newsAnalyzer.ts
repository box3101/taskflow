...
importance 기준:
- high: 주가 직접 영향 (실적, 수주, 계약, 규제, 소송, 대규모 투자, CEO/총수 면담, 주요 파트너사 CEO 방한·회동, 신사업 발표, 대규모 설비투자)
- medium: 업종/간접 영향 (경쟁사 실적, 산업 트렌드, 메모리 가격 동향, AI 수요 전망, 외국인/기관 수급)
- low: 주가와 무관 (정치, 연예, 단순 시황 요약, 행사, ETF 수익률 보도)
